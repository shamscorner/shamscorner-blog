            ...
            if (element == null) {
                ...
                if (!element.getContext) {
                    if (window.G_vmlCanvasManager) {
                        element = window.G_vmlCanvasManager.initElement(
                            element
                        );
                    } else {
                        throw new Error(
        ...
        function Plot(placeholder, data_, options_, plugins) {
            ...
            function setupGrid() {
                ...
                $.each(axes, function(_, axis) {
                    ...
                    axis.show =
                        axisOpts.show == null ? axis.used : axisOpts.show;
                    axis.reserveSpace =
            ...
            function highlight(s, point, auto) {
                ...
                if (typeof point == "number") {
                    ...
                    point = s.datapoints.points.slice(
                        ps * point,
                        ps * (point + 1)
                    );
                }
