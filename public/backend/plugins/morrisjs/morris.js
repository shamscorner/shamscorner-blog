            ...
            function Grid(options) {
                ...
                this.el.bind("mousemove", function(evt) {
                    ...
                    if (_this.selectFrom) {
                        left =
                            _this.data[
                                _this.hitTest(Math.min(x, _this.selectFrom))
                            ]._x;
                        right =
                            _this.data[
                                _this.hitTest(Math.max(x, _this.selectFrom))
                            ]._x;
                        width = right - left;
                ...
                if (typeof boundaryOption === "string") {
                    if (boundaryOption.slice(0, 4) === "auto") {
                        if (boundaryOption.length > 5) {
                            suggestedValue = parseInt(
                                boundaryOption.slice(5),
                                10
                            );
                            if (currentValue == null) {
                                return suggestedValue;
                            }
                            return Math[boundaryType](
                                currentValue,
                                suggestedValue
                            );
                        } else {
        ...
        Morris.parseDate = function(date) {
            ...
            if (m) {
                ...
                if (!q[6]) {
                    ...
                    if (q[6] !== "Z") {
                        offsetmins =
                            parseInt(q[8], 10) * 60 + parseInt(q[9], 10);
                        if (q[7] === "+") {
                ...
                if (!r[8]) {
                    ...
                    if (r[8] !== "Z") {
                        offsetmins =
                            parseInt(r[10], 10) * 60 + parseInt(r[11], 10);
                        if (r[9] === "+") {
                            offsetmins = 0 - offsetmins;
                        }
                    }
                        ...
                        smooth =
                            typeof this.options.smooth === "boolean"
                                ...
                                : ((_ref1 = this.options.ykeys[i]),
                                  __indexOf.call(this.options.smooth, _ref1) >=
                                      0);
                        coords = function() {
                    ...
                    if (
                        ...
                        if (_this.options.xLabelAngle !== 0) {
                            margin =
                                ...
                                Math.sin(
                                    (_this.options.xLabelAngle * Math.PI) /
                                        180.0
                                );
        ...
        Morris.Area = (function(_super) {
            ...
            function Area(options) {
                ...
                if (areaOptions.fillOpacity === "auto") {
                    areaOptions.fillOpacity = areaOptions.behaveLikeLine
                        ? 0.8
                        : 1;
                }
        ...
        Morris.Bar = (function(_super) {
            ...
            Bar.prototype.calcBars = function() {
                ...
                for (idx = _i = 0, _len = _ref.length; _i < _len; idx = ++_i) {
                    ...
                    row._x =
                        this.left +
                        (this.width * (idx + 0.5)) / this.data.length;
                    _results.push(
                        (row._y = function() {
                            var _j, _len1, _ref1, _results1;
                            _ref1 = row.y;
            ...
            Bar.prototype.drawSeries = function() {
                ...
                zeroPos =
                    this.ymin <= 0 && this.ymax >= 0 ? this.transY(0) : null;
                return (this.bars = function() {
                    var _i, _len, _ref, _results;
                    _ref = this.data;
                    _results = [];
                    for (
                        idx = _i = 0, _len = _ref.length;
                        _i < _len;
                        idx = ++_i
                    ) {
                        row = _ref[idx];
            ...
            Bar.prototype.hitTest = function(x) {
                ...
                return Math.min(
                    this.data.length - 1,
                    Math.floor(
                        (x - this.left) / (this.width / this.data.length)
                    )
                );
            };
            ...
            Donut.prototype.redraw = function() {
                ...
                for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
                    ...
                    seg = new Morris.DonutSegment(
                        ...
                        this.data[i].color ||
                            this.options.colors[
                                idx % this.options.colors.length
                            ],
